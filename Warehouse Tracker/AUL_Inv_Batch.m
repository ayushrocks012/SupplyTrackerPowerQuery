let
   ...
   #"Added Combined Storage Type" 
    ...
    #"Changed Type2" = Table.TransformColumnTypes(#"Grouped Rows",{{"Combined Storage Type", type text}, {"Combined Storage Bin", type text}, {"Warehouse", type text}})
in
    #"Changed Type2"
